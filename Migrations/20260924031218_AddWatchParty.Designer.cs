...
namespace MovieWeb.Migrations
{
    ...
    [Migration("20260924031218_AddWatchParty")]
    partial class AddWatchParty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieWeb.Models.Entities.CopyrightReport", b =>
                {
                    ...
                    b.Property<string>("ProofDetails")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("ProofDetails");
            ...
            modelBuilder.Entity("MovieWeb.Models.Entities.WatchPartyMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex(new[] { "ConnectionId" }, "IX_WatchPartyMembers_ConnectionId");

                    b.HasIndex(new[] { "RoomId" }, "IX_WatchPartyMembers_RoomId");

                    b.HasIndex(new[] { "UserId" }, "IX_WatchPartyMembers_UserId");

                    b.ToTable("WatchPartyMembers", (string)null);
                });

            modelBuilder.Entity("MovieWeb.Models.Entities.WatchPartyRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("OnlyHostControl")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
                    ...
                    b.HasIndex(new[] { "HostUserId" }, "IX_WatchPartyRooms_HostUserId");

                    b.HasIndex(new[] { "IsActive" }, "IX_WatchPartyRooms_IsActive");

                    b.HasIndex(new[] { "IsPrivate" }, "IX_WatchPartyRooms_IsPrivate");

                    b.HasIndex(new[] { "MovieId" }, "IX_WatchPartyRooms_MovieId");

                    b.HasIndex(new[] { "RoomCode" }, "IX_WatchPartyRooms_RoomCode")
                        .IsUnique();

                    b.HasIndex(new[] { "ShareToken" }, "IX_WatchPartyRooms_ShareToken")
                        .IsUnique();

                    b.ToTable("WatchPartyRooms", (string)null);
                });
            ...
            modelBuilder.Entity("MovieWeb.Models.Entities.WatchPartyMember", b =>
                {
                    b.HasOne("MovieWeb.Models.Entities.WatchPartyRoom", "Room")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("MovieWeb.Models.Entities.WatchPartyRoom", b =>
                {
                    b.HasOne("MovieWeb.Models.Entities.Episode", "Episode")
                        .WithMany()
                        .HasForeignKey("EpisodeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MovieWeb.Models.Entities.User", "HostUser")
                        .WithMany()
